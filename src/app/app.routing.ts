...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'form-controls',
        loadChildren:
          'app/pages/form-controls/form-controls.module#FormControlsModule',
      ...
      {
        path: 'drag-drop',
        loadChildren: 'app/pages/drag-drop/drag-drop.module#DragDropModule',
        data: { breadcrumb: 'Drag & Drop' },
      },
      {
        path: 'schedule',
        loadChildren: 'app/pages/schedule/schedule.module#ScheduleModule',
      ...
      },
      {
        path: 'dynamic-menu',
        loadChildren:
          'app/pages/dynamic-menu/dynamic-menu.module#DynamicMenuModule',
